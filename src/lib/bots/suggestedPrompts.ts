 ...
 * All data is created inside the function to avoid module-level initialization issues
 */
export function getSuggestedPrompts(
  ...
  try {
    // Create prompts inside function to ensure they're only evaluated when called
    const GENERAL_PROMPTS: { friend: SuggestedPrompt[]; mentor: SuggestedPrompt[]; ea: SuggestedPrompt[] } = {
      friend: [
        {
