  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-24">
        <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-up pt-16">
          {/* Main headline */}
          <motion.h1 
          ...
          >
            ...
            <br />
            <motion.span 
              className="text-foreground text-3xl md:text-4xl lg:text-5xl"
          ...
          >
            <Link to="/auth">
              <Button size="lg" className="text-lg px-8 h-14 transition-smooth hover:scale-105">
          ...
          >
            <div className="max-w-2xl mx-auto text-center space-y-3">
              <h3 className="text-lg font-semibold">Built for Founders, Creators, and 1-10 person teams</h3>
          ...
          <div className="pt-12 animate-scale-in" style={{ animationDelay: "0.2s" }}>
            <TabsDemo />
          </div>
        </div>
      </div>
